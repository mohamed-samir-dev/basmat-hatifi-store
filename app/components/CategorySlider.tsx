      ...
      <div className="marquee-track">
        {items.map((cat, i) => (
          <Link
            ...
            style={{ width: 100 }}
          >
            <div className="w-24 h-24 rounded-full bg-transparent border-2 border-gray-200 group-hover:border-teal-400 overflow-hidden relative transition-all duration-200 shadow-sm group-hover:shadow-md">
              {cat.image ? (
                <Image
                  src={cat.image}
                  alt={cat.name}
