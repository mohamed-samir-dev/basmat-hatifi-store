...
export const slugConfigs: Record<string, SlugConfig> = {
  ...
  "iphone-13-pro-max": {
    ...
    filters: { brand: "Apple", nameIncludes: ["13 pro max", "13 برو ماكس"] },
  },
  "iphone-14-pro-max": {
    label: "آيفون 14 برو ماكس",
    parentLabel: "الهواتف الذكية",
    parentHref: "/smartphones",
    filters: { brand: "Apple", nameIncludes: ["14 pro max", "14 برو ماكس"] },
  },
  "iphone-14-pro": {
    label: "آيفون 14 برو",
    parentLabel: "الهواتف الذكية",
    parentHref: "/smartphones",
    filters: { brand: "Apple", nameIncludes: ["14 pro", "14 برو"] },
  },
  "iphone-14-plus": {
    label: "آيفون 14 بلس",
    parentLabel: "الهواتف الذكية",
    parentHref: "/smartphones",
    filters: { brand: "Apple", nameIncludes: ["14 plus", "14 بلس"] },
  },
  "iphone-14": {
    label: "آيفون 14 عادي",
    parentLabel: "الهواتف الذكية",
    parentHref: "/smartphones",
    filters: { brand: "Apple", nameIncludes: ["iphone 14", "ايفون 14", "آيفون 14"] },
  },
  "iphone-15-pro-max": {
    label: "آيفون 15 برو ماكس",
    parentLabel: "الهواتف الذكية",
    parentHref: "/smartphones",
    filters: { brand: "Apple", nameIncludes: ["15 pro max", "15 برو ماكس"] },
  },
  "iphone-15-pro": {
    label: "آيفون 15 برو",
    parentLabel: "الهواتف الذكية",
    parentHref: "/smartphones",
    filters: { brand: "Apple", nameIncludes: ["15 pro", "15 برو"] },
  },
  "iphone-15-plus": {
    label: "آيفون 15 بلس",
    parentLabel: "الهواتف الذكية",
    parentHref: "/smartphones",
    filters: { brand: "Apple", nameIncludes: ["15 plus", "15 بلس"] },
  },
  "iphone-15": {
    label: "آيفون 15 عادي",
    parentLabel: "الهواتف الذكية",
    parentHref: "/smartphones",
    filters: { brand: "Apple", nameIncludes: ["iphone 15", "ايفون 15", "آيفون 15"] },
  },
  "iphone-16-pro-max": {
    label: "ابل ايفون 16 برو ماكس",
    parentLabel: "الهواتف الذكية",
    parentHref: "/smartphones",
    filters: { brand: "Apple", nameIncludes: ["16 pro max", "16 برو ماكس"] },
  },
  "iphone-16-pro": {
    label: "ابل ايفون 16 برو",
    parentLabel: "الهواتف الذكية",
    parentHref: "/smartphones",
    filters: { brand: "Apple", nameIncludes: ["16 pro", "16 برو"] },
  },
  "iphone-16-plus": {
    label: "ابل ايفون 16 بلس",
    parentLabel: "الهواتف الذكية",
    parentHref: "/smartphones",
    filters: { brand: "Apple", nameIncludes: ["16 plus", "16 بلس"] },
  },
  "iphone-16": {
  ...
  "iphone-17-pro-max": {
    ...
    parentLabel: "الهواتف الذكية",
    parentHref: "/smartphones",
    filters: { brand: "Apple", nameIncludes: ["17 pro max", "17 برو ماكس"] },
  },
  "iphone-17-pro": {
    label: "ابل ايفون 17 برو",
    parentLabel: "الهواتف الذكية",
    parentHref: "/smartphones",
    filters: { brand: "Apple", nameIncludes: ["17 pro", "17 برو"] },
  },
  "iphone-17": {
    label: "ابل ايفون 17 عادي",
    parentLabel: "الهواتف الذكية",
    parentHref: "/smartphones",
    filters: { brand: "Apple", nameIncludes: ["iphone 17", "ايفون 17", "آيفون 17"] },
  },
  "iphone-17-air": {
    label: "ابل ايفون 17 Air",
    parentLabel: "الهواتف الذكية",
    parentHref: "/smartphones",
    filters: { brand: "Apple", nameIncludes: ["17 air", "17 اير"] },
  },
  "apple-only": {
    label: "فقط آبل",
    parentLabel: "الهواتف الذكية",
  ...
  "samsung-s23-ultra": {
    ...
    parentLabel: "الهواتف الذكية",
    parentHref: "/smartphones",
    filters: { brand: "Samsung", nameIncludes: ["s23 ultra", "s23 الترا"] },
  },
  "samsung-s24-ultra": {
  ...
  "samsung-s26-ultra": {
    ...
    parentLabel: "الهواتف الذكية",
    parentHref: "/smartphones",
    filters: { brand: "Samsung", nameIncludes: ["s26 ultra", "s26 الترا"] },
  },
  ...
  se: {
    ...
    filters: { brand: "Apple", category: "watch" },
  },
  ...
  "airpods-pro": {
    ...
    parentHref: "/audio",
    filters: { brand: "Apple", category: "audio" },
  },
  "airpods-max": {
    label: "سماعات سبيكر",
    parentLabel: "أجهزة صوت و سماعات",
  ...
  "xbox-one": {
    ...
    parentLabel: "أجهزة بلاي ستيشن",
    parentHref: "/playstation",
    filters: { brand: "Microsoft", category: "xbox" },
  },
  controllers: {
    label: "يد تحكم",
    parentLabel: "أجهزة بلاي ستيشن",
  ...
  "macbook-pro": {
    ...
    parentHref: "/laptops",
    filters: { brand: "Apple", category: "laptop" },
  },
  "macbook-air": {
    label: "ماك بوك اير",
    parentLabel: "لابتوبات وشاشات",
  ...
  "samsung-monitors": {
    ...
    parentLabel: "لابتوبات وشاشات",
    parentHref: "/laptops",
    filters: { brand: "Samsung", category: "monitor" },
  },
